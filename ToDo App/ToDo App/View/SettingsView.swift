...
//  ToDo App
//
//  Created by Faza Elrahman on 24/02/21.
//
...
struct SettingsView: View {
    ...
    var body: some View {
            ...
            VStack(alignment: .center, spacing: 0){
                ...
                Form {
                    ...
                    Section(header: Text("Follow us on social media")) {
                        ...
                        FormRowLinkView(icon: "link", color: Color.blue, text: "Facebook", link: "https://www.facebook.com/ghaza.putra.794/")
        ...
        .navigationBarTitle("Setinggs", displayMode: .inline)
